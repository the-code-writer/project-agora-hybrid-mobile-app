...
export declare type StateChangeListener = (state: ScreenReaderState) => void;
 ...
 * @since 1.0.0
 */
export declare type AccessibilitySpeakOptions = SpeakOptions;
/**
 * @deprecated Use `StateChangeListener`.
 * @since 1.0.0
 */
export declare type ScreenReaderStateChangeCallback = StateChangeListener;
