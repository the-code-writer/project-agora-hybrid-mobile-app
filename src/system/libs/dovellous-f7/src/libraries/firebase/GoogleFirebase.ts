...
export class GoogleFirebase {
  ...
  constructor(
    authentication: GoogleFirebaseAuthenticationConfig | Config,
  ...
  private initGoogleFirebaseAuthentication() {
    this.googleFirebaseAuthentication = new GoogleFirebaseAuthentication(
      this.config.authentication
    );
  }
  ...
  private initGoogleRealtimeDatabase() {
    this.googleRealtimeDatabase = new GoogleRealtimeDatabase(
      this.config.database
    );
  }

  public authSignInWithGoogle(): {} {

    return this.googleFirebaseAuthentication.signInWithGoogle();
